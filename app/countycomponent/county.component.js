...
var CountyComponent = (function () {
    function CountyComponent(userService, countyservice) {
    ...
    CountyComponent.prototype.getAllCounties = function () {
        var _this = this;
    ...
    CountyComponent.prototype.getUsers = function () {
        var _this = this;
        this.userService.getUsers()
            ...
            console.log('this.users[0].name=' + _this.users[0].name);
        }, //Bind to view
        function (//Bind to view
            err) {
            // Log errors if any
